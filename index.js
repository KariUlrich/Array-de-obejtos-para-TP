...
//4. Crea un nuevo objeto llamado nuevaOperacion con los siguientes valores: para descripcion, 
// "Veterinaria". Para categoria, "Mascotas". Para fecha, "19/01/2021". Para monto, "2500". Para tipo, "Gasto".
...
// lo tendra como un string. (Pista: despues de hacer el ejercicio 6, chequea con un console log que 
// operaciones siga teniendo sus propiedades monto como numero. Si no es asi, recorda usar el spread operator!)

// const copiaOperaciones = operaciones.map((operacion) => {
//     let nuevoObjeto= {...operacion}
//     nuevoObjeto.monto = String(nuevoObjeto.monto)
//     return nuevoObjeto
// })
...
// 9. Recorre con un map operaciones y guarda en una nueva variable totalGastos la suma de todos 
// los montos de los objetos cuyo tipo sea "gasto" (Pista: vas a necesitar una acumuladora)


// const arrayDeGastos = operaciones.filter((operacion) => {
//     return operacion.tipo === 'Gasto'
// })
// console.log(arrayDeGastos)

// let acc = 0
// const totalGastos = arrayDeGastos.map((gasto) => {
//     acc = acc + gasto.monto
// })
// console.log(acc)
...
const convertirOperacionesaHTML = (operaciones) => {
    operaciones.map((operacion) => {
        ...
        <p id="descripcion-item-operacion" class="column is-3 mr-0-mobile has-text-weight-semibold">${operacion.descripcion}</p>
        <div class="column is-3 is-6-mobile">
          <p id="categoria-item-operacion" class="tag is-primary is-light">${operacion.categoria}</p>
        </div>
